...
if __name__ == '__main__':
    ...
    parser.add_argument('--bert_json_dir', type=str, default="./bert/bert-base-uncased/bert_config.json")
    parser.add_argument('--bert_checkpoint_dir', type=str, default="./bert/bert-base-uncased/pytorch_model.bin")
