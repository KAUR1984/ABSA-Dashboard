...
from models.AspectBasedSentimentAnalysis.grammar.chunker import Chunker
from models.AspectBasedSentimentAnalysis.grammar.language_processor import LanguageProcessor
from models.AspectBasedSentimentAnalysis.grammar.pattern_grammar import Target
from models.AspectBasedSentimentAnalysis.grammar.pos_tagger import PosTagger
from models.AspectBasedSentimentAnalysis.grammar.sentiment import Sentiment

STOP_WORDS = set(stopwords.words('english'))
# logging.info("STOP_WORDS SIZE: {}".format(len(STOP_WORDS)))
import pandas as pd

less_adj = set(pd.read_csv('models/AspectBasedSentimentAnalysis/dataset/sentiment_words_text_files/less_adj.csv')['less_adjective'].tolist())
