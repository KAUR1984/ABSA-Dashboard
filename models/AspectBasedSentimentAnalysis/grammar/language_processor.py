...
from models.AspectBasedSentimentAnalysis.grammar.sentiment import NEGATIVE_SENTIMENT_SCORE
from models.AspectBasedSentimentAnalysis.grammar.sentiment import POSITIVE_SENTIMENT_SCORE
