...
from models.AspectBasedSentimentAnalysis.feature_extraction.feature_vector_builder import get_syntactic_grammar_feature_vector
from models.AspectBasedSentimentAnalysis.grammar.source_target_extractor import SourceTargetExtractor
from models.AspectBasedSentimentAnalysis.training.mid_stage_prepare_dataset import extract_mid_stage_label_dataframe
from models.AspectBasedSentimentAnalysis.training.mid_stage_prepare_dataset import get_dataset
...
from models.AspectBasedSentimentAnalysis.training.mid_stage_prepare_dataset import ONLY_ASPECT_PREDICTION
...
COLUMN_PKL_FILE = '/tmp/_{}_column_to_delete.pkl'.format(
    ONLY_ASPECT_PREDICTION)
TRAINING_DATA = [
    'models/AspectBasedSentimentAnalysis/dataset/annoted_data.json',
...
TESTING_DATA_FILE = 'models/AspectBasedSentimentAnalysis/dataset/ABSA15_Restaurants_Test.json'
...
def prediction_for_pipe():
    return pd.read_csv('models/AspectBasedSentimentAnalysis/prediction_step_rows.csv')
